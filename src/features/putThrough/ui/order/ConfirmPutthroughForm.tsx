...
import { useForm } from "react-hook-form"; import { orderSide } from "../../putthroughConfig";
...
import CheckBoxFormField from "@/components/inputs/checkBox/CheckBoxFormField";
...
const ConfirmPutThroughForm = () => {
  ...
  const brokerIdF2 = form.watch('brokerIdF2')
      ...
      <div className="grid grid-cols-2 gap-4 h-full">
            ...
            <div>
              <Form.Field label="Loại lệnh">
                <SelectFormField
                  ...
                  options={orderSide}
                  mode="label"
                  iClassName={sideF1 === "B" ? 'bg-bg-buy!' : 'bg-bg-sell!'}
                />
              </Form.Field>
        ...
        <div className="border border-bd-default rounded flex flex-col">
          ...
          <div className="grid grid-cols-3 gap-2 p-2">
            ...
            <Form.Field label="TraderId">
              <TextFormField name='traderIdF2' disabled value={brokerIdF2 ? `0${brokerIdF2}1` : ''} />
            </Form.Field>
            ...
            <Form.Field label="Sức mua" >
              <div>{accountBalance?.accType === 'N' ? numberFormat(accountBalance?.balance) : numberFormat(accountBalance?.volumeAvaiable)}</div>
            </Form.Field>
          </div>
          <div className='flex gap-2 justify-end mt-auto p-2'>
            <Button className='w-22' variant='close' onClick={handleOnClickCancel}>Hủy lệnh</Button>
            <Button className='w-22' variant='close' onClick={handleOnClickCancel}>Từ chối</Button>
...
export default ConfirmPutThroughForm;