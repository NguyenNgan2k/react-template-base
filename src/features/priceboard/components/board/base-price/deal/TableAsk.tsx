...
function TableAsk({ addresses }: { addresses?: unknown[] }) {
  ...
  return (
    <div
      className="h-[calc(var(--app-height)-289px)] overflow-hidden relative flex flex-col"
      ref={containerRef}
    >
      ...
      <div className="overflow-hidden">
        {/* <List
          ...
          rowCount={addresses && addresses?.length || 0}
          rowHeight={25}
          rowProps={{ addresses }}
